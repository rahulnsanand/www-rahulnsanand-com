...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `https://www.rahulnsanand.com/llms-full.txt`, lastModified: new Date("2026-03-17T06:59:59.163Z"), changeFrequency: "weekly", priority: 0.7 },
    { url: `https://www.rahulnsanand.com/llms.txt`, lastModified: new Date("2026-03-17T06:59:59.163Z"), changeFrequency: "weekly", priority: 0.7 },
    ...
    { url: `https://www.rahulnsanand.com/seo/content-index.json`, lastModified: new Date("2026-03-17T06:59:59.163Z"), changeFrequency: "weekly", priority: 0.7 },
  ];
}
